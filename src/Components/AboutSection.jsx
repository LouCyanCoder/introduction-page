			...
			<div className="container">
				...
				<div className="about__desc" data-aos="fade-left">
					<p>
						...
						IT and design. I’m now looking for new opportunities where I can
						focus on frontend development and continue growing toward fullstack.
						I enjoy creating clean, responsive interfaces that make the web
