...
const AboutSection = () => {
  return (
    <section id="about" className="about">
        ...
        <img src={require("../img/profile-photo.jpg")} alt="about-image" className="about__img"  data-aos="fade-right"/>
        <div className="about__desc" data-aos="fade-left">
            <p><strong>My name is Lucian Nguyen</strong> I am web developer and enjoy learning
                new trends. <strong>I have a background in marketing/polygraphy and IT support.</strong> </p>
            <p> During my time in marketing/polygraphy I have helped to establish over numerous new companies or improve their existing ones in Czech Republic.</p>
            ...
            <a href="#contact" className="btn btn-warning">Contact me</a>
        </div>
    </section>
  )
}
