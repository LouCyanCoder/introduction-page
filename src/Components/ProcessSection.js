		...
		<section className="process">
			...
			<div className="process__container">
				<div className="process__item" data-aos="fade-up">
					...
					<p data-aos="fade-up">
						Tell me about your project and we brainstorm together the features
						to create a plan for your product to launch.
					</p>
				</div>
				...
				<div className="process__item" data-aos="fade-up">
					...
					<p data-aos="fade-up">
						We protoype and develop your product. We work together intensely to
